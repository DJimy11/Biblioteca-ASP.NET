    ...
    public class EditorialLogica
    {
        ...
        public bool Registrar(Editorial oEditorial)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("sp_RegistrarEditora", oConexion);
        ...
        public bool Modificar(Editorial oEditorial)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("sp_ModificarEditora", oConexion);
        ...
        public List<Editorial> Listar()
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("select IdEditorial,Descripcion,Estado from Editora", oConexion);
        ...
        public bool Eliminar(int id)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("delete from Editora where idEditorial = @id", oConexion);
