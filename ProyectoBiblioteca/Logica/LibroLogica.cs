    ...
    public class LibroLogica
    {
        ...
        public List<Libro> Listar()
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                ...
                sb.AppendLine("inner join EDITORA e on e.IdEditorial = l.IdEditorial");
        ...
        public int Registrar(Libro objeto)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("sp_registrarLivro", oConexion);
        ...
        public bool Modificar(Libro objeto)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("sp_modificarLivro", oConexion);
        ...
        public bool Eliminar(int id)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("delete from LIVRO where IdLibro = @id", oConexion);
